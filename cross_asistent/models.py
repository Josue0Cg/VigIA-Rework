...
# Stub: kept for old migration compatibility (Banners model was removed)
...
class Preguntas(models.Model):
    nombre_persona = models.CharField(max_length=100, default='Anónimo')
    ...
    def __str__(self):
        return f"{self.nombre_persona}: {self.pregunta}"
